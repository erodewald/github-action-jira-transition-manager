...
export declare class Board {
    ...
    getAllSprints<T = Paginated<Models.SprintBean[]>>(parameters: Parameters.GetAllSprints, callback: Callback<T>): Promise<void>;
    /** Returns all sprints from a board, for a given board ID. This only includes sprints that the user has permission to view. */
    getAllSprints<T = Paginated<Models.SprintBean[]>>(parameters: Parameters.GetAllSprints, callback?: never): Promise<T>;
    /**
