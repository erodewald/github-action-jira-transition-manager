...
export declare class Sprint {
     ...
     *  </p>
     */
    createSprint<T = Models.SprintBean>(parameters: Parameters.CreateSprint | undefined, callback: Callback<T>): Promise<void>;
    /**
     * Creates a future sprint. Sprint name and origin board id are required. Start date, end date, and goal are optional. <p>
     *  Note that the sprint name is trimmed. Also, when starting sprints from the UI, the "endDate" set through this
     *  call is ignored and instead the last sprint's duration is used to fill the form.
     *  </p>
     */
    createSprint<T = Models.SprintBean>(parameters?: Parameters.CreateSprint, callback?: never): Promise<T>;
    /**
     ...
     */
    getSprint<T = Models.SprintBean>(parameters: Parameters.GetSprint, callback: Callback<T>): Promise<void>;
    /**
     * Returns the sprint for a given sprint ID. The sprint will only be returned if the user can view the board that the
     * sprint was created on, or view at least one of the issues in the sprint.
     */
    getSprint<T = Models.SprintBean>(parameters: Parameters.GetSprint, callback?: never): Promise<T>;
    /**
     ...
     *  </ul>
     */
    partiallyUpdateSprint<T = Models.SprintBean>(parameters: Parameters.PartiallyUpdateSprint, callback: Callback<T>): Promise<void>;
    /**
     * Performs a partial update of a sprint. A partial update means that fields not present in the request JSON will not
     * be updated. <p>Notes:</p>
     *  <ul>
     ...
     *  </ul>
     */
    partiallyUpdateSprint<T = Models.SprintBean>(parameters: Parameters.PartiallyUpdateSprint, callback?: never): Promise<T>;
    /**
     ...
     *  </ul>
     */
    updateSprint<T = Models.SprintBean>(parameters: Parameters.UpdateSprint, callback: Callback<T>): Promise<void>;
    /**
     * Performs a full update of a sprint. A full update means that the result will be exactly the same as the request
     * body. Any fields not present in the request JSON will be set to null. <p>Notes:</p>
     *  <ul>
     ...
     *  </ul>
     */
    updateSprint<T = Models.SprintBean>(parameters: Parameters.UpdateSprint, callback?: never): Promise<T>;
     ...
     */
    getIssuesForSprint<T = Models.IssueBean>(parameters: Parameters.GetIssuesForSprint, callback: Callback<T>): Promise<void>;
    /**
     * Returns all issues in a sprint, for a given sprint ID. This only includes issues that the user has permission to
     * view. By default, the returned issues are ordered by rank.
     */
    getIssuesForSprint<T = Models.IssueBean>(parameters: Parameters.GetIssuesForSprint, callback?: never): Promise<T>;
    /**
